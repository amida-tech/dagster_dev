...
def convert_csv_to_parquet(
    ...
    start with `prefix`, converts each to Parquet, and writes it into
    ...
    source_fs = client.get_file_system_client(source_container)
    dest_fs = client.get_file_system_client(dest_container)
